# 🐉 Dragon Heaven: Multi-Page Website
...
![Accessibility](https://img.shields.io/badge/A11y-Compliant-4C51BF?style=for-the-badge)

**A fully responsive, accessible multi-page website showcasing dragons with semantic HTML and modern CSS techniques**

[View Demo](#how-to-run) • [Features](#key-features) • [Tech Stack](#technical-skills-demonstrated)
...
```
public/
├── index.html      # 🏠 Homepage with dragon content cards
├── about.html      # 📖 Detailed dragon lore and information
...
- 👤 **Personal Collection**: Original photography

> 📄 Complete attribution and license details available in `licenses.txt`
...
- 🔧 **Maintainable**: Organized CSS with clear naming conventions
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](your-github)
